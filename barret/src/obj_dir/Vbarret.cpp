...
VL_INLINE_OPT void Vbarret::_combo__TOP__1(Vbarret__Syms* __restrict vlSymsp) {
    ...
    Vbarret* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->barret__DOT__test = (0xfU & ((IData)(vlTOPp->din_a) 
                                         - ((3U & (
                                                   ((IData)(5U) 
                                                    * 
                                                    (0xfU 
                                                   ...
                                                   >> 2U)) 
                                            * (IData)(vlTOPp->din_m))));
    vlTOPp->dout_r = (3U & (((IData)(vlTOPp->barret__DOT__test) 
                             >= (IData)(vlTOPp->din_m))
                             ? ((IData)(vlTOPp->barret__DOT__test) 
                                - (IData)(3U)) : (IData)(vlTOPp->barret__DOT__test)));
}
...
void Vbarret::_eval_debug_assertions() {
    ...
    if (VL_UNLIKELY((din_a & 0xf0U))) {
        Verilated::overWidthError("din_a");}
    if (VL_UNLIKELY((din_m & 0xf0U))) {
        Verilated::overWidthError("din_m");}
}
#endif  // VL_DEBUG
